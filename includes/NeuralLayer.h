...
public:
    ...
    void ConnectLayer(NeuralLayer& other, const array<Weights>& weights);
    
    // This will return the neurons from the layer
    array<Neuron>& GetNeurons();
    ...
    void SetWeights(array<Weights>& weights);
